...
mkdir $TMPDIR/$scene
for SUBDIR in pred_consensus_no_cmx color depth label-filt intrinsic omnidata_depth omnidata_normal pose pred_sam pred_consensus refinedpose pred_consensus_5_scannet
do
    echo Copying $SUBDIR ...

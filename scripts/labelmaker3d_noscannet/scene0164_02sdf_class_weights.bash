...
scene=scene0164_02
experiment_name=${scene}_no_scannet_class_weights
echo $scene
echo $scene

mkdir $TMPDIR/$scene
for SUBDIR in color depth label-filt intrinsic omnidata_depth omnidata_normal pose pred_sam pred_consensus pred_consensus_noscannet
do  
    echo Copying $SUBDIR ...

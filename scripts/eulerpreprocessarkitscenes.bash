...
seg2=$(sbatch $commonargs --time=04:00:00 --wrap="bash -c './scripts/copy_arkitscenes.bash $scene && python scripts/segmentation_ovseg.py --classes wn_nodef --flip \$TMPDIR/$scene && cp -r \$TMPDIR/$scene/pred_ovseg_wn_nodef_flip /cluster/project/cvg/blumh/arkitscenes/$scene/'")

seg3=$(sbatch $commonargs --time=04:00:00 --wrap="bash -c './scripts/copy_arkitscenes.bash $scene && python scripts/segmentation_internimage.py \$TMPDIR/$scene && cp -r \$TMPDIR/$scene/pred_internimage /cluster/project/cvg/blumh/arkitscenes/$scene/'")
seg4=$(sbatch $commonargs --time=04:00:00 --wrap="bash -c './scripts/copy_arkitscenes.bash $scene && python scripts/segmentation_internimage.py --flip \$TMPDIR/$scene && cp -r \$TMPDIR/$scene/pred_internimage_flip /cluster/project/cvg/blumh/arkitscenes/$scene/'")

sam=$(sbatch $commonargs --time=22:00:00 --wrap="bash -c './scripts/copy_arkitscenes.bash $scene && python scripts/segmentation_sam.py \$TMPDIR/$scene && cp -r \$TMPDIR/$scene/pred_sam /cluster/project/cvg/blumh/arkitscenes/$scene/'")

#  -d afterany:$depth 
seg5=$(sbatch $commonargs -d afterany:$depth --time=04:00:00 --wrap="bash -c './scripts/copy_arkitscenes.bash $scene && cp -r $scenefolder/hha \$TMPDIR/$scene/ && python scripts/segmentation_cmx.py \$TMPDIR/$scene && cp -r \$TMPDIR/$scene/pred_cmx /cluster/project/cvg/blumh/arkitscenes/$scene/'")

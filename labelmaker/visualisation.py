...
class GenericMask:
  ...
  def __init__(self, mask_or_polygons, height, width):
    ...
    raise ValueError("GenericMask cannot handle object {} of type '{}'".format(
        m, type(m)))
...
def draw_text(
  ...
  """
    ...
    """
  if not font_size:
    font_size = max(np.sqrt(vis.height * vis.width) // 90, 10 // vis.scale)
...
def draw_binary_mask(binary_mask,
                     vis,
                     color=None,
                     *,
                     edge_color=None,

...
experiment_name=${scene}_scannet_weight_5_class_weights_no_mask3d
echo $scene
echo $scene

mkdir $TMPDIR/$scene
for SUBDIR in pred_consensus_no_mask3d color depth label-filt intrinsic omnidata_depth omnidata_normal pose pred_sam pred_consensus pred_consensus_5_scannet
do
    echo Copying $SUBDIR ...
